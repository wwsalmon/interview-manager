...
export function Container({children, topbar, hasUnsaved, isLoading, onSave}: {children: ReactNode, topbar: ReactNode, hasUnsaved: boolean, isLoading: boolean, onSave: () => any}) {
    return (
